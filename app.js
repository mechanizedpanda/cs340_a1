...
PORT        = 9912;                 // Set a port number at the top so it's easy to change in the future
...
app.engine('.hbs', exphbs({                     // Create an instance of the handlebars engine to process templates
    extname: ".hbs"                                  // Tell express to use the handlebars engine whenever it encounters a *.hbs file.
}));
